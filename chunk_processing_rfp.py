...
#         logger.info("Using simple chunking mode - no semantic analysis")
...
#             logger.info(f"Document exceeds token limit of {self.max_chunk_size}. Splitting into simple chunks...")
            
#             chunks = self.simple_chunk_text(text)
#             logger.info(f"Split document into {len(chunks)} chunks using simple word-based chunking")
